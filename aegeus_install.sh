...
COIN_TGZ='https://github.com/Realbityoda/Aegeus/releases/download/v1.1.1.1/Aegeus.tar.gz'
...
purgeOldInstallation() {
    ...
    #kill wallet daemon
    sudo killall aegeusd > /dev/null 2>&1
    #remove old ufw port allow
    sudo ufw delete allow 29328/tcp > /dev/null 2>&1
    #remove old files
    if [ -d "~/.aegeus" ]; then
        sudo rm -rf ~/.aegeus > /dev/null 2>&1
    fi
    #remove binaries and Aegeus utilities
    cd /usr/local/bin && sudo rm aegeus-cli aegeus-tx aegeusd > /dev/null 2>&1 && cd
...
function important_information() {
 echo
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${PURPLE}Windows Wallet Guide. https://github.com/Realbityoda/Aegeus/blob/master/README.md${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
